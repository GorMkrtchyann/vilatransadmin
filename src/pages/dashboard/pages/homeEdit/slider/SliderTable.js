            ...
            <div className="blockForm__table__body">
                {allData.map((elem, index) => (
                    <div key={elem._id} className={'blockForm__table__body__item'}>
                        ...
                        <div>
                            {elem?.medias.src?.startsWith("data:image") ?
                                <img className={'list-img'} src={elem?.medias.src} alt="img"/> :
                                <video src={elem?.medias.src} className={'list-img'} autoPlay={true} loop={true} muted={true}/>}
                        </div>
